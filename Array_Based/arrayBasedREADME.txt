...
DESCRIPTION:
	...
	This program sustains student records of a class. This program also has functionality through a menu. The functionality of the program include printing records of students, searching students by first name and displaying it, searching students by last name and displaying it, sorting students by score in descending order, sort students by last name [A-Z], find maximum score, find minimum score and display records of students, and exit program.
...
INPUTS:
	...
	v. 1 20 character string when searching for first name in class

	vi. 1 20 character string when searching for last name in class

	vii. 1 integer value used for menu
...
RUNNING IT:
	...
	x. If you enter 2 the program will prompt you to enter a 20 character string first name and display any student who matches with that name.

	xi. If you enter 3 the program will prompt you to enter a 20 character string last name and display any student who matches with that name.
 
	xii. If you enter 4 the program will sort the records of the students based on score in descending order. [High to Low]

	xiii. If you enter 5 the program will sort the records of the students based on last name in alphabetical order [A-Z]

	xix. If you enter 6 the program will print the records of all students with the highest score

	xx. If you enter 7 the program will print the records of all students with the lowest score.
